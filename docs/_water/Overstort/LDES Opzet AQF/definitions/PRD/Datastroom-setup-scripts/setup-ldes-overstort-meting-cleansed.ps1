...
Invoke-RestMethod -Method Post -Uri "https://ldes-overstort.prd.az.aquafin.be/ldes/admin/api/v1/eventstreams" -ContentType "text/turtle" -InFile ".\overstort-meting-cleansed.ttl"
...
Invoke-RestMethod -Method Post -Uri "https://ldes-overstort.prd.az.aquafin.be/ldes/admin/api/v1/eventstreams/overstort-meting-cleansed/views" -ContentType "text/turtle" -InFile ".\overstort.overstort-meting-cleansed-by-page.ttl"
Start-Sleep -Seconds 5


# Define pipelines
Write-Host "Defining pipelines..."
Invoke-RestMethod -Method Post -Uri "https://ldio-overstort.prd.az.aquafin.be/admin/api/v1/pipeline" -ContentType "application/yaml" -InFile ".\overstort-meting-cleansed.yml"
Start-Sleep -Seconds 5
